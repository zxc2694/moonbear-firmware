...
void system_init(void)
{
	...
	PID_Pitch.Ki = 0;
	PID_Pitch.Kd = +1.8f;	//1.5f * 0.7 = 1.05f

	PID_Roll.Kp = +4.0f;	//4.0f * 0.7 = 2.8f
	PID_Roll.Ki = 0;
	PID_Roll.Kd = +1.8f ;	//1.5f * 0.7 = 1.05f
...
#if QuadrotorMotorcycle
			Final_M1 = 180 + Thr + Pitch - Roll + Yaw; 
			Final_M2 = 180+ Thr + Pitch + Roll - Yaw; 
			Final_M3 = 180 + Thr - Pitch + Roll + Yaw; 
			Final_M4 = 180 + Thr - Pitch - Roll - Yaw; 
#endif				

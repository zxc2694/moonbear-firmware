...
void system_init(void)
{
	...
	PID_Pitch.Kp = +2.8f;	//4.0f * 0.7
	PID_Pitch.Ki = 0;
	PID_Pitch.Kd = +1.05f;	//1.5f * 0.7

	PID_Roll.Kp = +2.8f;	//4.0f * 0.7
	PID_Roll.Ki = 0;
	PID_Roll.Kd = 1.05f;	//1.5f * 0.7

	PID_Yaw.Kp = +3.5f;		//5.0f * 0.7
	PID_Yaw.Ki = 0;
	PID_Yaw.Kd = +10.5f;	//15.0f * 0.7
